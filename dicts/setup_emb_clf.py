...
if __name__ == '__main__':
    ...
    df = pd.read_csv('/home/gridsan/ychai/geotweet-sentiment-geography/data/labeled_data/training.1600000.processed.noemoticon.csv', encoding='latin', header=None, usecols=[0,5])
