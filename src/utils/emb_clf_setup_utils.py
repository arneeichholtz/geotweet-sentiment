...
def split_train_test(df, args):
    ...
    with open('/Users/arneeichholtz/Documents/GitHub/geotweet-sentiment-geography/data/labeled_data/train_ids.txt', 'w') as fp:
        json.dump(train_ids, fp)
    with open('/Users/arneeichholtz/Documents/GitHub/geotweet-sentiment-geography/data/labeled_data/test_ids.txt', 'w') as fp:
...
def train_model(train_df, train_embeddings, args):
    ...
    clf = pipe.fit(X, y) # So is X then reduced to pca_dims dimensions?
