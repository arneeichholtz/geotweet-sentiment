#usage: python src/main_affected_tweets.py --countries USA --text_path /home/sentiment/data-lake/twitter/processed/ --geo_path /home/sentiment/data-lake/twitter/geoinfo/
...
if __name__ == '__main__':
    ...
    parser.add_argument('--platform', default='twitter', help='Which social media data are we using (twitter, weibo)?')
